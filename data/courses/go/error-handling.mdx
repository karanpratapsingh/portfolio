...
date: '2022-05-12'
draft: false
summary: 'In this tutorial, we will learn about error handling in Go'
...
Here, we will use `[errors.As](http://errors.As)` instead of `[errors.Is](http://errors.Is)` function, to convert the error to the correct type.
