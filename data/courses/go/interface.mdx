...
In this section, let's talk about the interface.
...
![no-interface](/static/courses/go/chapter-III/interface/no-interface.png)
...
![interface](/static/courses/go/chapter-III/interface/interface.png)
...
![interface-implementation](/static/courses/go/chapter-III/interface/interface-implementation.png)
