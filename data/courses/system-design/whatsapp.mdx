...
As per our requirements, we also know that around 5 percent of our daily messages (100 million) are media files. If we assume each file is 50 KB on average, we will require 10 TB of object storage every day.

$$
2 \space billion \times 100 \space million \times 100 \space KB = 10 \space TB/day
$$
...
As our system is handling 10.2 TB of ingress every day, so we will a require minimum bandwidth of around 120 MB per second.
