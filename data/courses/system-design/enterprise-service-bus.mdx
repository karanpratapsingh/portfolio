...
In theory, a centralized ESB offers the potential to standardize and dramatically simplify communication, messaging, and integration between services across the enterprise. Here are some advantages of enterprise service bus:
...
- **Greater resilience: F**ailure of one component does not impact the others, and each microservice can perform to its own availability requirements without staking the other components to a ‘greatest common availability’ requirement.

## Disadvantages

While ESBs were deployed successfully in many organizations, in many other organizations the ESB came to be seen as the bottleneck. Here are some disadvantages of enterprise service bus:

- Making changes or enhancements to one integration could destabilize others who used that same integration.
