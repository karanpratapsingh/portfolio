...
Disaster recovery (DR) is a process of regaining access and functionality infrastructure after events like a natural disaster, cyber attack, or even business disruptions.
...
_Disaster Recovery is often not actively discussed during system design but it's important to have some basic understanding of this topic. You can learn more about disaster recovery from [AWS](https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/plan-for-disaster-recovery-dr.html)._
...
This is the simplest type of disaster recovery and entails storing data off-site or on a removable drive.
