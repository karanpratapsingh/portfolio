...
![oauth2](/static/courses/system-design/chapter-IV/oauth-2-and-openid-connect/oauth2.png)
...
Both OAuth 2.0 and OIDC are easy to implement and are JSON based, which is supported by most web and mobile applications. However, the OpenID Connect specification is more stringent than that of basic OAuth.
