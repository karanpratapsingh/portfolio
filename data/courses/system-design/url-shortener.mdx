...
Let's design a URL shortener, similar to services like [bit.ly](https://bitly.com/), [tinyURL](https://tinyurl.com/app).
...
**urls**
Contains the new short URL's properties such as `expiration`, `hash`, `originalURL`, and `userID` of the user who created the short URL.
...
`createURL` API should create a new short URL in our system given an orignal URL.
...
`deleteURL` API should delete a given shortURL from our system.
