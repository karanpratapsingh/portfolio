...
date: '2022-10-01'
draft: false
summary: 'In this tutorial we will discuss Load Balancer'
images: ['/static/courses/system-design/chapter-I/load-balancer/banner.png']
authors: ['default']
---
...
![load-balancer](/static/courses/system-design/chapter-I/load-balancer/load-balancer.png)

For additional scalability and redundancy, we can try to load balance at each layer of our system:

![load-balancer-layers](/static/courses/system-design/chapter-I/load-balancer/load-balancer-layers.png)
...
![redundant-load-balancer](/static/courses/system-design/chapter-I/load-balancer/redundant-load-balancer.png)
