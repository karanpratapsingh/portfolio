...
In this architecture, the presentation layer runs on the client and communicates with a datastore. There is no business logic layer or immediate layer between client and server.
...
- Expensive as every tier can have its own hardware cost.
