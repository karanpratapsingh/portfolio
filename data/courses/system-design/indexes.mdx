...
One quality that database indexes can have is that they can be _dense_ or _sparse_. Each of these index qualities comes with their own trade-offs. Let's look at how each index type would work:
