...
One quality that database indexes can have is that they can be *dense* or *sparse*. Each of these index qualities comes with their own trade-offs. Let's look at how each index type would work:
