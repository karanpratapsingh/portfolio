...
![reconciliation loop illustration](https://raw.githubusercontent.com/karanpratapsingh/portfolio/refs/heads/master/public/static/blogs/kubernetes-operators/reconcile-loop.png align="center")
...
A [**Helm chart**](https://helm.sh/docs/topics/charts/) renders a set of values into YAML and applies it once. It has no way to keep watching afterward. if a resource it created is deleted or drifts, Helm has no idea until we run `helm upgrade` again by hand.
...
![informer, workqueue, and reconciler pipeline](https://raw.githubusercontent.com/karanpratapsingh/portfolio/refs/heads/master/public/static/blogs/kubernetes-operators/informer-pipeline.png align="center")
...
![VMOperator architecture](https://raw.githubusercontent.com/karanpratapsingh/portfolio/refs/heads/master/public/static/blogs/kubernetes-operators/vmoperator-architecture.png align="center")
...
![cross-resource reconciliation fan-out](https://raw.githubusercontent.com/karanpratapsingh/portfolio/refs/heads/master/public/static/blogs/kubernetes-operators/cross-resource-fanout.png align="center")
...
**Note:** VMOperator manages a resource entirely outside the cluster through a hand-rolled HTTP client, but it's not a novel pattern. [Crossplane](https://www.crossplane.io/), [AWS Controllers for Kubernetes](https://aws-controllers-k8s.github.io/community/), [Cluster API](https://cluster-api.sigs.k8s.io/), and cert-manager all reconcile external or non-Kubernetes state through CRDs the same way. These resources are worth reading once this pattern feels familiar.
